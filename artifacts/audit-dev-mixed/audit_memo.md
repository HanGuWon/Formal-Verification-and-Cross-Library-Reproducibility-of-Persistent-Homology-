...
Audited 2 disagreeing dimension records from 1 discrepancy cases.
...
The full audit command is `PYTHONPATH=src python scripts/run_audit_conventions.py --conformance-dir artifacts --output-dir artifacts/audit-dev-mixed`.
...
`zero-length bar reporting`: 0 record(s).
`cutoff tie semantics`: 1 record(s).
`alpha vs 2alpha` candidates: 0 record(s); none survived inspection as a plausible global scaling convention.

Minimal reproducible example: `triangular_patch_3x3__floating__p2__h2__selected` dimension `1`.
Saved input: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev-mixed/minimal_repros/convention_mismatch/distance_matrix.npy`.
Exact command: `PYTHONPATH=src python scripts/run_audit_conventions.py --conformance-dir artifacts --output-dir artifacts/audit-dev-mixed --case-id triangular_patch_3x3__floating__p2__h2__selected`.
Before/after plot: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev-mixed/minimal_repros/convention_mismatch/convention_mismatch_before_after.png`.
...
1 disagreeing dimension record(s) fall in this class. In every such case the disagreement is confined to floating mode `H0`, and GUDHI matches Ripser.py/Dionysus after a float32 round-trip of the endpoints.
...
Minimal reproducible example: `triangular_patch_3x3__floating__p2__h2__selected` dimension `0`.
Saved input: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev-mixed/minimal_repros/floating_point_artifact/distance_matrix.npy`.
Exact command: `PYTHONPATH=src python scripts/run_audit_conventions.py --conformance-dir artifacts --output-dir artifacts/audit-dev-mixed --case-id triangular_patch_3x3__floating__p2__h2__selected`.
Before/after plot: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev-mixed/minimal_repros/floating_point_artifact/floating_point_artifact_before_after.png`.
