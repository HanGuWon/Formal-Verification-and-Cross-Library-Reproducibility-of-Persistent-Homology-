...
The full audit command is `PYTHONPATH=src python scripts/run_audit_conventions.py --conformance-dir artifacts --output-dir artifacts/audit-dev`.
...
0 disagreeing dimension record(s) fall in this class. These are zero-metric disagreements where GUDHI emits extra cutoff-touching bars that Ripser.py and Dionysus omit.
...
Minimal reproducible example: `tfim_obc_n4_g0p50__floating__p2__h1__selected` dimension `0`.
Saved input: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev/minimal_repros/floating_point_artifact/distance_matrix.npy`.
Exact command: `PYTHONPATH=src python scripts/run_audit_conventions.py --conformance-dir artifacts --output-dir artifacts/audit-dev --case-id tfim_obc_n4_g0p50__floating__p2__h1__selected`.
Before/after plot: `/mnt/c/Users/한구원/Desktop/Formal-Verification-and-Cross-Library-Reproducibility-of-Persistent-Homology-/artifacts/audit-dev/minimal_repros/floating_point_artifact/floating_point_artifact_before_after.png`.
